...
func TestGetBranchesWithStringName_FilterAndFormatting(t *testing.T) {
    ...
    // Act
    allTimes, allAuthors, err := GetBranchesWithStringName("")
    require.NoError(t, err)
    only8stashTimes, only8stashAuthors, err := GetBranchesWithStringName("8stash/")
    require.NoError(t, err)
...
func TestGetBranchesWithStringName_NotARepo(t *testing.T) {
    ...
    // Act
    _, _, err = GetBranchesWithStringName("")
